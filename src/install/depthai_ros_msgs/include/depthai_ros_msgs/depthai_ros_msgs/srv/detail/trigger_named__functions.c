...
depthai_ros_msgs__srv__TriggerNamed_Request__create(void)
{
...
depthai_ros_msgs__srv__TriggerNamed_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
depthai_ros_msgs__srv__TriggerNamed_Event__init(depthai_ros_msgs__srv__TriggerNamed_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    depthai_ros_msgs__srv__TriggerNamed_Event__fini(msg);
    return false;
  }
  // request
  if (!depthai_ros_msgs__srv__TriggerNamed_Request__Sequence__init(&msg->request, 0)) {
    depthai_ros_msgs__srv__TriggerNamed_Event__fini(msg);
    return false;
  }
  // response
  if (!depthai_ros_msgs__srv__TriggerNamed_Response__Sequence__init(&msg->response, 0)) {
    depthai_ros_msgs__srv__TriggerNamed_Event__fini(msg);
    return false;
  }
  return true;
...
void
depthai_ros_msgs__srv__TriggerNamed_Event__fini(depthai_ros_msgs__srv__TriggerNamed_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  depthai_ros_msgs__srv__TriggerNamed_Request__Sequence__fini(&msg->request);
  // response
  depthai_ros_msgs__srv__TriggerNamed_Response__Sequence__fini(&msg->response);
}

bool
depthai_ros_msgs__srv__TriggerNamed_Event__are_equal(const depthai_ros_msgs__srv__TriggerNamed_Event * lhs, const depthai_ros_msgs__srv__TriggerNamed_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!depthai_ros_msgs__srv__TriggerNamed_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!depthai_ros_msgs__srv__TriggerNamed_Response__Sequence__are_equal(
...
bool
depthai_ros_msgs__srv__TriggerNamed_Event__copy(
  const depthai_ros_msgs__srv__TriggerNamed_Event * input,
  depthai_ros_msgs__srv__TriggerNamed_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!depthai_ros_msgs__srv__TriggerNamed_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!depthai_ros_msgs__srv__TriggerNamed_Response__Sequence__copy(
...
depthai_ros_msgs__srv__TriggerNamed_Event *
depthai_ros_msgs__srv__TriggerNamed_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  depthai_ros_msgs__srv__TriggerNamed_Event * msg = (depthai_ros_msgs__srv__TriggerNamed_Event *)allocator.allocate(sizeof(depthai_ros_msgs__srv__TriggerNamed_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(depthai_ros_msgs__srv__TriggerNamed_Event));
  bool success = depthai_ros_msgs__srv__TriggerNamed_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
depthai_ros_msgs__srv__TriggerNamed_Event__destroy(depthai_ros_msgs__srv__TriggerNamed_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    depthai_ros_msgs__srv__TriggerNamed_Event__fini(msg);
...
bool
depthai_ros_msgs__srv__TriggerNamed_Event__Sequence__init(depthai_ros_msgs__srv__TriggerNamed_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  depthai_ros_msgs__srv__TriggerNamed_Event * data = NULL;

  if (size) {
    data = (depthai_ros_msgs__srv__TriggerNamed_Event *)allocator.zero_allocate(size, sizeof(depthai_ros_msgs__srv__TriggerNamed_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = depthai_ros_msgs__srv__TriggerNamed_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        depthai_ros_msgs__srv__TriggerNamed_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
depthai_ros_msgs__srv__TriggerNamed_Event__Sequence__fini(depthai_ros_msgs__srv__TriggerNamed_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      depthai_ros_msgs__srv__TriggerNamed_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
depthai_ros_msgs__srv__TriggerNamed_Event__Sequence *
depthai_ros_msgs__srv__TriggerNamed_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  depthai_ros_msgs__srv__TriggerNamed_Event__Sequence * array = (depthai_ros_msgs__srv__TriggerNamed_Event__Sequence *)allocator.allocate(sizeof(depthai_ros_msgs__srv__TriggerNamed_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = depthai_ros_msgs__srv__TriggerNamed_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
depthai_ros_msgs__srv__TriggerNamed_Event__Sequence__destroy(depthai_ros_msgs__srv__TriggerNamed_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    depthai_ros_msgs__srv__TriggerNamed_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
depthai_ros_msgs__srv__TriggerNamed_Event__Sequence__are_equal(const depthai_ros_msgs__srv__TriggerNamed_Event__Sequence * lhs, const depthai_ros_msgs__srv__TriggerNamed_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!depthai_ros_msgs__srv__TriggerNamed_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
depthai_ros_msgs__srv__TriggerNamed_Event__Sequence__copy(
  const depthai_ros_msgs__srv__TriggerNamed_Event__Sequence * input,
  depthai_ros_msgs__srv__TriggerNamed_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(depthai_ros_msgs__srv__TriggerNamed_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    depthai_ros_msgs__srv__TriggerNamed_Event * data =
      (depthai_ros_msgs__srv__TriggerNamed_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!depthai_ros_msgs__srv__TriggerNamed_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          depthai_ros_msgs__srv__TriggerNamed_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!depthai_ros_msgs__srv__TriggerNamed_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
