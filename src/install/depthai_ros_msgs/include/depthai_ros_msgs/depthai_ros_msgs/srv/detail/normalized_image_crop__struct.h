...
enum
{
  depthai_ros_msgs__srv__NormalizedImageCrop_Event__request__MAX_SIZE = 1
};
// response
enum
{
  depthai_ros_msgs__srv__NormalizedImageCrop_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/NormalizedImageCrop in the package depthai_ros_msgs.
typedef struct depthai_ros_msgs__srv__NormalizedImageCrop_Event
{
  service_msgs__msg__ServiceEventInfo info;
  depthai_ros_msgs__srv__NormalizedImageCrop_Request__Sequence request;
  depthai_ros_msgs__srv__NormalizedImageCrop_Response__Sequence response;
} depthai_ros_msgs__srv__NormalizedImageCrop_Event;

// Struct for a sequence of depthai_ros_msgs__srv__NormalizedImageCrop_Event.
typedef struct depthai_ros_msgs__srv__NormalizedImageCrop_Event__Sequence
{
