...
enum
{
  depthai_ros_msgs__srv__TriggerNamed_Event__request__MAX_SIZE = 1
};
// response
enum
{
  depthai_ros_msgs__srv__TriggerNamed_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/TriggerNamed in the package depthai_ros_msgs.
typedef struct depthai_ros_msgs__srv__TriggerNamed_Event
{
  service_msgs__msg__ServiceEventInfo info;
  depthai_ros_msgs__srv__TriggerNamed_Request__Sequence request;
  depthai_ros_msgs__srv__TriggerNamed_Response__Sequence response;
} depthai_ros_msgs__srv__TriggerNamed_Event;

// Struct for a sequence of depthai_ros_msgs__srv__TriggerNamed_Event.
typedef struct depthai_ros_msgs__srv__TriggerNamed_Event__Sequence
{
