...
// IWYU pragma: private, include "depthai_ros_msgs/srv/trigger_named.hpp"
...
#ifndef _WIN32
# define DEPRECATED__depthai_ros_msgs__srv__TriggerNamed_Event __attribute__((deprecated))
#else
# define DEPRECATED__depthai_ros_msgs__srv__TriggerNamed_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct TriggerNamed_Event_
{
  using Type = TriggerNamed_Event_<ContainerAllocator>;

  explicit TriggerNamed_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit TriggerNamed_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<depthai_ros_msgs::srv::TriggerNamed_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<depthai_ros_msgs::srv::TriggerNamed_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<depthai_ros_msgs::srv::TriggerNamed_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<depthai_ros_msgs::srv::TriggerNamed_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<depthai_ros_msgs::srv::TriggerNamed_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<depthai_ros_msgs::srv::TriggerNamed_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<depthai_ros_msgs::srv::TriggerNamed_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<depthai_ros_msgs::srv::TriggerNamed_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__depthai_ros_msgs__srv__TriggerNamed_Event
    std::shared_ptr<depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__depthai_ros_msgs__srv__TriggerNamed_Event
    std::shared_ptr<depthai_ros_msgs::srv::TriggerNamed_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const TriggerNamed_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using TriggerNamed_Event =
  depthai_ros_msgs::srv::TriggerNamed_Event_<std::allocator<void>>;
...
struct TriggerNamed
{
  ...
  using Event = depthai_ros_msgs::srv::TriggerNamed_Event;
};
