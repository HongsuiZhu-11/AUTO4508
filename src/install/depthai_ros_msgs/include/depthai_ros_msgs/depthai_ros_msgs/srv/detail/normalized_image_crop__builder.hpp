...
class Init_NormalizedImageCrop_Event_response
{
public:
  explicit Init_NormalizedImageCrop_Event_response(::depthai_ros_msgs::srv::NormalizedImageCrop_Event & msg)
  : msg_(msg)
  {}
  ::depthai_ros_msgs::srv::NormalizedImageCrop_Event response(::depthai_ros_msgs::srv::NormalizedImageCrop_Event::_response_type arg)
  {
...
private:
  ::depthai_ros_msgs::srv::NormalizedImageCrop_Event msg_;
};

class Init_NormalizedImageCrop_Event_request
{
public:
  explicit Init_NormalizedImageCrop_Event_request(::depthai_ros_msgs::srv::NormalizedImageCrop_Event & msg)
  : msg_(msg)
  {}
  Init_NormalizedImageCrop_Event_response request(::depthai_ros_msgs::srv::NormalizedImageCrop_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_NormalizedImageCrop_Event_response(msg_);
  }
...
class Init_NormalizedImageCrop_Event_info
{
public:
  Init_NormalizedImageCrop_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_NormalizedImageCrop_Event_request info(::depthai_ros_msgs::srv::NormalizedImageCrop_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_NormalizedImageCrop_Event_request(msg_);
  }
...
template<>
inline
auto build<::depthai_ros_msgs::srv::NormalizedImageCrop_Event>()
{
  return depthai_ros_msgs::srv::builder::Init_NormalizedImageCrop_Event_info();
}
