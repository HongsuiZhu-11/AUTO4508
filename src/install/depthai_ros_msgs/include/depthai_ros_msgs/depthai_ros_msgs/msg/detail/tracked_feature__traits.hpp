...
// IWYU pragma: private, include "depthai_ros_msgs/msg/tracked_feature.hpp"
  ...
  std::ostream & out)
{
  ...
  {
    out << "harris_score: ";
    rosidl_generator_traits::value_to_yaml(msg.harris_score, out);
    out << ", ";
  }
...
inline std::string to_yaml(const TrackedFeature & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const depthai_ros_msgs::msg::TrackedFeature & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const depthai_ros_msgs::msg::TrackedFeature & msg)
{
