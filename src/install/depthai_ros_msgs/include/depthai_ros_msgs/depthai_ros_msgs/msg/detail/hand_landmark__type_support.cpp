...
void fetch_function__HandLandmark__landmark(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Pose2D *>(
    get_const_function__HandLandmark__landmark(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Pose2D *>(untyped_value);
  value = item;
}

void assign_function__HandLandmark__landmark(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Pose2D *>(
    get_function__HandLandmark__landmark(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HandLandmark_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__HandLandmark__landmark,  // fetch(index, &value) function pointer
    assign_function__HandLandmark__landmark,  // assign(index, value) function pointer
